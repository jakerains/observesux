          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {currentDigest ? (
              <div className="space-y-2">
                ...
                <p className="text-[10px] text-muted-foreground/50 italic text-right pr-2">
                  This digest was generated by SUX, the Siouxland Assistant, from public data sources.
                </p>
              </div>
            ) : (
