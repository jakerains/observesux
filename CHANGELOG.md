...
- Splash screen with progress bar on initial page load
  - Shows logo centered with loading progress
  - Tracks 6 data sources and fills to 100% when loaded
...
### Added
- Collapsible layers menu on interactive map - tap "Layers" to expand/collapse

### Changed
- PWA app name now displays as "Siouxland Online" on home screens
